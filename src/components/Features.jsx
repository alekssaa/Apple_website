...
const Features = () => {
    ...
    useGSAP(() => {
        ...
        animateWithGsap(".g_text", {y:0, opacity: 1, ease:"power1", duration:1})
  },[])
  return (
      <section className="h-full common-padding  bg-zinc relative overflow-hidden">
          <div className="screen-max-width">
              ...
              <div className="flex flex-col justify-center items-center overflow-hidden">
                  ...
                  <div className="flex-center flex-col sm:px-10 pl-2" >
                      ...
                      <div className="flex flex-cpl w-full relative">
